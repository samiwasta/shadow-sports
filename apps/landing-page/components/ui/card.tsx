...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, variant, title, description, children, ...props }, ref) => {
    ...
    const PlusIcons = () => (
      <>
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="absolute -top-3 -left-3 size-6 text-black dark:text-white"
        >
          <path
            strokeLinecap="round"
        ...
        <svg
          ...
          strokeWidth="1"
          stroke="currentColor"
          className="absolute -top-3 -right-3 size-6 text-black dark:text-white"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    const CornerBorders = () => (
      <>
        <div className="absolute -top-0.5 -left-0.5 size-6 rounded-tl-md border-l-2 border-t-2 border-zinc-700 dark:border-zinc-200" />
        <div className="absolute -top-0.5 -right-0.5 size-6 rounded-tr-md border-r-2 border-t-2 border-zinc-700 dark:border-zinc-200" />
        ...
        <div className="absolute -right-0.5 -bottom-0.5 size-6 rounded-br-md border-r-2 border-b-2 border-zinc-700 dark:border-zinc-200" />
      </>
    )
